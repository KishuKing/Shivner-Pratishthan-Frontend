...
import { FaArrowLeft, FaCheckCircle, FaInfoCircle, FaUpload, FaTimesCircle } from 'react-icons/fa'
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-3xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="py-8 px-6 sm:px-10 space-y-8">
            ...
            <div>
              <label htmlFor="motivation" className="block text-sm font-medium text-gray-700">Why do you want to volunteer with us?</label>
              <textarea
                name="motivation"
                id="motivation"
                rows="3"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <span className="ml-1 text-xs text-gray-500">(Aadhar Card, Driving License, etc.)</span>
              </label>
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md relative">
                {preview ? (
                  <div className="relative">
                    <img src={preview} alt="Document preview" className="max-h-48 rounded" />
                    <button
                      type="button"
                      onClick={removeFile}
            ...
            <div className="text-sm text-gray-600 flex items-start bg-blue-50 p-4 rounded-md">
              ...
              <p>
                ...
                <Link to="/terms-and-conditions" className="text-[#26B947] hover:text-[#1f9939] ml-1">
