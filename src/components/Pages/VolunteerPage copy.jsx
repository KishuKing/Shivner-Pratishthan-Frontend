          ...
          {activeTab === 'Overview' && (
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-start gap-3">
                ...
                <p>Village development plays a vital role in shaping the sustainable future of India. With a significant portion of the population residing in rural areas, it is essential to focus on creating sustainable communities that promote economic growth, environmental conservation, and social well-being.</p>
              </li>
            </ul>
          )}
          {activeTab === 'Impact' &&  (
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 mt-2 rounded-full bg-[#26B947]" />
                <p>Our impact reaches across multiple villages, helping thousands of families improve their quality of life through sustainable development initiatives, education programs, and healthcare services.</p>
              </li>
            </ul>
          )}
