  ...
  const activities = [
    {
      ...
      description:
        "Regular medical check-ups and health awareness programs for our residents.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Social Activities",
      description:
        "Group activities and cultural programs to promote social interaction.",
    },
    {
      icon: <MapPin className="h-6 w-6" />,
      title: "Outreach Programs",
      description:
        "Community outreach initiatives to support elderly in surrounding areas.",
    },
  ];
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <motion.div
              ...
              <p className="text-lg text-gray-600">
                Through our various programs and activities, we strive to create
                an engaging and supportive environment for our elderly
                residents.
              </p>
            </motion.div>
            <motion.div
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We organize various activities to ensure the physical and mental
      ...
      <section className="py-16 bg-[#f0fff0]">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Join us in our upcoming events and make a difference in the lives
              of our seniors
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the various initiatives we've undertaken to enhance the
              lives of our elderly residents
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-[#f0fff0]">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mb-8">
            There are many ways you can contribute to our cause and help make a
            difference in the lives of our elderly residents.
          </p>
          <Link
            href="/contact"
