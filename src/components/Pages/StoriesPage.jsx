  ...
  const stories = [
    {
      ...
      quote:
        "Finding a new family here has given me a reason to smile every day.",
      story:
        "After losing my husband, I felt so alone. But the warmth and care I've received here has filled my heart with joy again. From morning yoga to evening singalongs, every day is a new adventure.",
    },
    {
      id: 2,
      name: "Raj Sharma",
      ...
      story:
        "I spent my life as a banker, but here I've found my true passion - painting. The art therapy sessions have opened up a whole new world for me. Now, my grandchildren fight over who gets to keep my latest masterpiece!",
    },
    {
      id: 3,
      name: "Meera Gupta",
      ...
      story:
        "I was worried about making friends at my age, but I've met the most wonderful people here. We laugh, we share stories, and we support each other. It's like being back in school, but with much better stories to tell!",
    },
  ];
  ...
  const sections = [
    {
      ...
      description:
        "Experience the vibrant daily life of our residents through these snapshots.",
      images: [
        {
        ...
        {
          src: "/placeholder.svg?height=300&width=400",
          alt: "Art therapy class in progress",
        },
      ],
      extraImages: [
        {
          src: "/placeholder.svg?height=300&width=400",
          alt: "Evening music program",
        },
        {
          src: "/placeholder.svg?height=300&width=400",
          alt: "Residents in the garden",
        },
      ],
    },
    {
      ...
      description:
        "We make sure to celebrate every occasion with enthusiasm and joy.",
      images: [
        {
          src: "/placeholder.svg?height=300&width=400",
    ...
    },
    {
      title: "Family Visits",
      description:
        "The joy of family reunions captured in these heartwarming moments.",
      images: [
        {
          src: "/placeholder.svg?height=300&width=400",
          alt: "Grandchildren visiting",
        },
        {
          src: "/placeholder.svg?height=300&width=400",
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#efffef] via-[#f7fff7] to-white">
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-24">
          <div className="text-center space-y-8">
            ...
            <p className="text-gray-600 leading-relaxed text-lg max-w-[720px] mx-auto">
              Every resident at Shivner Pratishthan has a unique story to tell.
              These stories of resilience, joy, and new beginnings inspire us
              every day. Dive into our collection of heartwarming narratives and
              vibrant moments.
            </p>
          </div>
        </div>
                    ...
                    {stories.map((_, index) => (
                      <div
                        ...
                        className={`w-3 h-3 rounded-full ${
                          index === activeStory ? "bg-[#26B947]" : "bg-gray-300"
                        }`}></div>
                    ))}
                  </div>
                  <button
      ...
      {sections.map((section, index) => (
        <section
          key={index}
          className={`py-16 ${index % 2 === 0 ? "bg-white" : "bg-[#f0fff0]"}`}>
      ...
      <section className="max-w-[800px] mx-auto px-6 py-24 text-center">
        ...
        <p className="text-gray-600 mb-8">
          Your support can help create more heartwarming stories and joyful
          moments for our residents. Join us in making a difference in their
          lives.
        </p>
        <a
          href="/donate"
