  ...
  const features = [
    {
      ...
      title: "Elderly Care",
      description:
        "Providing comprehensive care and support to senior citizens in our facilities.",
    },
    {
      icon: <Users className="h-8 w-8" />,
      title: "Community Support",
      description:
        "Building a strong community network to ensure no elderly person feels alone.",
    },
    {
      icon: <Calendar className="h-8 w-8" />,
      title: "Regular Activities",
      description:
        "Organizing engaging activities and events to keep our residents active and happy.",
    },
  ];
            ...
            <motion.div
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm tracking-wider font-medium">
                  WELCOME TO SHIVNER PRATISHTHAN
                </span>
              </div>
              ...
              <p className="text-lg text-gray-600">
                We are dedicated to supporting senior citizens in Old Age Homes
                in Pune, Maharashtra. Our mission is to enhance the quality of
                life for the elderly through comprehensive care and support.
              </p>
            ...
            <motion.div
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-6 max-w-[240px]">
                ...
                <p className="text-sm text-gray-600">
                  Dedicated to serving our elderly community since 2009
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                <h3 className="text-4xl font-bold text-[#26B947] mb-2">
                  {stat.number}
                </h3>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide comprehensive support and care for the elderly through
      ...
      <section className="py-16 bg-[#f0fff0]">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Join us in our mission to provide care and support to the elderly.
            Your contribution can help create a better life for our seniors.
          </p>
