...
import { FaArrowLeft, FaCheckCircle, FaInfoCircle, FaMoneyBillWave, FaBoxOpen } from 'react-icons/fa';
              ...
              <div className="mt-1 flex space-x-4">
                <label className="flex-1 relative block cursor-pointer">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`px-4 py-3 border rounded-lg flex items-center justify-center transition-all duration-300 ${formData.donationType === 'money' ? 'bg-[#26B947] text-white border-[#26B947]' : 'bg-white text-gray-700 border-gray-300 hover:border-[#26B947]'}`}>
                ...
                <label className="flex-1 relative block cursor-pointer">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`px-4 py-3 border rounded-lg flex items-center justify-center transition-all duration-300 ${formData.donationType === 'items' ? 'bg-[#26B947] text-white border-[#26B947]' : 'bg-white text-gray-700 border-gray-300 hover:border-[#26B947]'}`}>
